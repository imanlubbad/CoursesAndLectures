...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull LinearLayout rootView, @NonNull CheckedTextView text1) {
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.text1;
      CheckedTextView text1 = ViewBindings.findChildViewById(rootView, id);
      if (text1 == null) {
        break missingId;
      }

      return new ItemListBinding((LinearLayout) rootView, text1);
    }
